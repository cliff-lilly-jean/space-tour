...
const Home = () => {
 return (
  <div className='home flex flex-col justify-between items-center md:pt-0 ml-auto mr-auto h-screen'>
   <Navbar />
   <div className="container flex flex-col justify-between h-full items-center text-center lg:text-left lg:flex-row max-w-6xl p-5 m-auto">
    <div className="container__left mt-16 max-w-[327px] md:mt-0 md:mb-0 md:max-w-lg">
    ...
    <div className="container__right mb-0 w-[150px] md:w-[150px] lg:w-[274px] hover:cursor-pointer hover:shadow-exploreShadow hover:transition-all rounded-full">
